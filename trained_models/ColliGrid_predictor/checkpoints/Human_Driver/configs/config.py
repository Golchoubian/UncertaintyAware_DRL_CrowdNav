...
class Config(object):
    ...
    # 'none': no prediction
    sim.predict_method = 'none' # Also adjust the uncertainty-aware args in the argument.py file!
    ...
    robot.human_driver = True # only works for no prediction case ('PedSim-v0' in argument and 'none' in config) in test.py file
