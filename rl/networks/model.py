...
from .selfAttn_RH_RV import double_selfAttn
...
class Policy(nn.Module):
    ...
    def __init__(self, obs_shape, action_space, base=None, base_kwargs=None):
        ...
        elif base == 'social_move_plan' and base_kwargs.consider_veh == False:
            base = selfAttn_merge_SRNN
        elif base == 'social_move_plan' and base_kwargs.consider_veh == True:
            base = double_selfAttn
        else:
